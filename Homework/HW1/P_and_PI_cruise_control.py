...
u_cmd = v_des*b*2 #open-loop command (see in-class calculation of this value)
...
print("for open-loop:", ctrl.pole(sys))
print("for closed-loop with kp:", ctrl.pole(sys_P_control))
print("for closed-loop with kp and ki:", ctrl.pole(sys_PI_control))
