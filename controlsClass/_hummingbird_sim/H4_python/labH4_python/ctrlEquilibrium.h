...
class CtrlEquilibrium  {
  public:
    ...
    void update(State state, MotorUtilities &rotors) {
      ...
      // Get the values from the joy stick
      ...
      //   case 0:
      //     if (km_try > 4.0) { state_machine = 1; } // If the theta ref is pushed up, then go to case 1
      //     if (theta_ref < 1.5) { state_machine = 2; } // If the theta ref is pushed down, then go to case 2
      //     break;
      //   case 1:
      //     P.km += -0.001;
      //     state_machine = 3;
      ...
      //   // print theta and km
      // Serial.print("km: ");  
      // // Serial.print(P.km, 4); // This line is sending a float through the serial
      // Serial.print(P.km);
      // Serial.print(",");
      // Serial.print("theta: ");
      // Serial.print(180/PI*state.theta);
      // Serial.print(",");
